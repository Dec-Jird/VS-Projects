    ...
    public class CertUtil
    {
        ...
        private static void initSignCert(string certPath, string certPwd)
        {
            ...
            try
            {
                ...
                Log.i("签名证书读取成功，序列号：" + signCert.certId);
        ...
        private static void initEncryptCert()
        {
            ...
            try
            {
                ...
                Log.i("加密证书读取成功，序列号：" + encryptCert.certId);
            }
            finally
            {
                if (fileStream != null)
        ...
        private static void initMiddleCert()
        {
            ...
            {
                Log.e("middleCertPath为空或路径不存在，请检查配置文件middleCertPath的配置情况。");
                return;
            }
            FileStream fileStream = null;
            try
        ...
        private static void initRootCert()
        {
            ...
            {
                Log.e("rootCertPath为空或路径不存在，请检查配置文件rootCertPath的配置情况。");
                return;
            }
            FileStream fileStream = null;
            try
        ...
        public static X509Certificate GetPubKeyCert(string pubKeyCert)
        {
            try{
                ...
                Log.i("signPubKeyCert: " + pubKeyCert);
            ...
            {
                Log.e("convert pubKeyCert failed.", e);
                return null;
            }
        }
        ...
        private static Boolean VerifyCertificateChain(X509Certificate cert)
        {
            if (null == cert)
            {
                Log.e("cert must Not null");
                return false;
            }
            X509Certificate rootCert = GetRootCert();
            if (null == rootCert)
            {
                Log.e("rootCert must Not null");
                return false;
            }
            X509Certificate middleCert = GetMiddleCert();
            if (null == middleCert)
            {
                Log.e("middleCert must Not null");
                return false;
            }
            ...
            try {
                ...
                Log.i("verify certificate chain succeed.");
			    return true;
            }
            catch (PkixCertPathBuilderException e)
            {
                Log.e("verify certificate chain fail.", e);
		    } catch (Exception e) {
                Log.e("verify certificate chain exception: ", e);
		    }
		    return false;
        }
        ...
        private static Boolean VerifyCertificate(X509Certificate x509Cert)
        {
            ...
            {
                Log.e("verifyCertificate fail", e);
                return false;
            }
        ...
        private static void initCerCerts()
        {
            ...
            foreach (FileInfo file in files)
            {
                ...
                try
                {
                    ...
                    Log.i(file.Name + "读取成功，序列号：" + cert.certId);
                }
                finally
                {
                    if(fileStream != null)
